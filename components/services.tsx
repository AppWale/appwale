  ...
  const features = [
    {
      ...
      description:
        "Professional, responsive websites crafted to build trust, attract customers, and grow your business online.",
    },
    {
      icon: <Circle className="w-6 h-6" />,
      title: "Mobile Applications",
      description:
        "Modern Android and iOS applications designed for seamless experiences, better engagement, and business growth.",
    },
    {
      icon: <Triangle className="w-6 h-6" />,
      title: "SEO & Performance",
      description:
        "Fast-loading, search-friendly solutions optimized for performance across every device and screen size.",
    },
    {
      icon: <Hexagon className="w-6 h-6" />,
      title: "Reliable Support",
      description:
        "Timely delivery, transparent communication, and dependable support to keep your digital products running.",
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white">
            Websites & Apps
            <br />
            <span className="text-white/70">Built for Businesses</span>
          </h2>
        </motion.div>
