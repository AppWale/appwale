      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between">
          <Link href="/" className="text-white font-bold text-2xl tracking-tighter">
            APPWALE<span className="text-neutral-400">.</span>
          </Link>
          ...
          <div className="hidden md:block">
            <button className="border border-white px-5 py-2 text-sm uppercase tracking-widest hover:bg-white hover:text-black transition-colors" onClick={() => window.location.href = '#contact'}>
              Contact
            </button>
          </div>
